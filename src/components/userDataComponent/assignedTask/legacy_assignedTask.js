                    ...
                    <div className="add-section">
                        ...
                        {(showTaskComponent == "list" && showSequence == false) &&
                            ...
                            >
                                ...
                                {listSequenceFalseItem.map((item, i) => {
                                    return (
                                        <div key={i} className="input-row row">
                                            <div className="col-6">
                                                <input name={"false_item_" + i} className="add-inputs" placeholder={item.placeHolder}
                                                    value={infoDetails["false_item_" + i] == undefined ? "" : infoDetails["false_item_" + i]}
                                                    onChange={(e) => {
                                                        var details = { ...infoDetails };
                                                        details["false_item_" + i] = e.target.value;
