...
export function result(endPointURL) {
    return axios.post(URL + endPointURL, config)
}
...
export function resultGet(endPointURL) {
    return axios.get(URL + endPointURL, {
        headers: {
            'Authorization': 'Bearer ' + localStorage.token
        }
    })
...
export function getPatientPersonalInfoAPI(patientID) {
    return axios.get(URL + 'v1/patients/' + patientID, {
        headers: {
            'Authorization': 'Bearer ' + localStorage.token
        }
    });
...
export function getPatientMedicationDataAPI(patientID) {
    return axios.get(URL + 'v1/patient-medication/' + patientID, {
        headers: {
            'Authorization': 'Bearer ' + localStorage.token
        }
    });
...
export function getPatientHealthDataAPI(patientID) {
    return axios.get(URL + 'v1/patient-health-data/' + patientID, {
        headers: {
            'Authorization': 'Bearer ' + localStorage.token
        }
    });
...
export function getAssignedDataAPI(patientID) {
    return axios.get(URL + 'v1/tasks?patient_id=' + patientID, {
        headers: {
            'Authorization': 'Bearer ' + localStorage.token
        }
    });
...
export function getPatientTaskDataAPI(patientID) {
    ...
    return axios.get(URL + 'v1/task-group?patient_id=' + patientID, {
        headers: {
            'Authorization': 'Bearer ' + localStorage.token
        }
    });
